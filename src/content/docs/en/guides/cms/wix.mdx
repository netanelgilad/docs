...
:::tip
If you are deploying your project to Wix, check out the guide on [Environment Variables with the Wix CLI](../cli//local-development.md).
:::
...
To deploy your project to Wix, you'll use the [Wix CLI](../cli/deploying-to-wix.md) to upload your build output to Wix.
...
out the [Wix CLI documentation on custom frontends](https://www.npmjs.com/package/@wix/cli-edge).
:::
